...
class TestEventModel(TestCase):
    ...
    def setUp(self):
        ...
        Event.objects.create(
            id = 1,
            title = "event test",
            description = "This is a test for the service method to get an event from id",
    ...
    def test_get_event_successful(self):
        ...
        self.assertEqual(event.description, "This is a test for the service method to get an event from id")
